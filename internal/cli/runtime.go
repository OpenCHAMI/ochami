...
func NewRuntime() *Runtime {
	return &Runtime{
		Ios:          NewIOStreams(Ios.In(), Ios.Out(), Ios.Err()),
...
// MustFromContext retrieves the Runtime from the context, panicking if not found.
func MustFromContext(ctx context.Context) *Runtime {
