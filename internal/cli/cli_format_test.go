...
// TestApplyFormatFlags_NilCommand verifies error handling for nil command.
...
// TestApplyFormatFlags_NilRuntime verifies error handling for nil runtime.
...
// TestApplyFormatFlags_InvalidFormat verifies error handling for invalid format values.
func TestApplyFormatFlags_InvalidFormat(t *testing.T) {
	t.Parallel()
