...
ochami discover static [--overwrite] [-f _format_] [_file_]
...
*static* [--overwrite] [-f _format_] [_file_]
...
format of the input data is JSON by default, but *-f* can be used to specify a
different format.
