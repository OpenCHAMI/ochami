...
// TestDiscoverStaticComponentFailure verifies handling when component discovery fails.
func TestDiscoverStaticComponentFailure(t *testing.T) {
	t.Parallel()
...
// TestDiscoverStaticRedfishFailure verifies handling when Redfish endpoint discovery fails.
func TestDiscoverStaticRedfishFailure(t *testing.T) {
	t.Parallel()
...
// TestDiscoverStaticEthernetFailure verifies handling when Ethernet interface discovery fails.
func TestDiscoverStaticEthernetFailure(t *testing.T) {
	t.Parallel()
...
// TestDiscoverStaticGroupFailure verifies handling when group discovery fails.
func TestDiscoverStaticGroupFailure(t *testing.T) {
	t.Parallel()
...
// TestDiscoverStaticConflictFlow verifies handling of create-to-update conflict flows.
func TestDiscoverStaticConflictFlow(t *testing.T) {
	t.Parallel()
...
// TestDiscoverStaticMalformedBatch verifies handling of malformed one-item batch cardinality.
func TestDiscoverStaticMalformedBatch(t *testing.T) {
	t.Parallel()
...
// TestDiscoverStaticSuccess verifies normal static discovery works.
...
func TestDiscoverStaticSuccess(t *testing.T) {
	t.Parallel()
