...
var discoverStaticCmd = &cobra.Command{
	Use:   "static [--overwrite] [--payload-format <format>] [payload_file]",
	Args:  cobra.NoArgs,
...
func init() {
	discoverStaticCmd.Flags().String("payload-format", defaultPayloadFormat, "format of payload file (yaml,json) passed with --payload")
